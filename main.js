...
function createProjectAdder() {
  ...
  add_project_form.addEventListener("submit", (event) => {
    ...
    if (_storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.some((project) => project.name === name_input.value)) {

...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (loadProjectList);
...
function loadAllTasks() {
  ...
  for (let projectObject of _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList) {
...
function loadTodayTasks() {
  ...
  for (let projectObject of _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList) {
    for (let taskObject of projectObject.getTasks()) {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(taskObject.getDueDate(), new Date())) {
        const today_task = createTaskDOM(taskObject, projectObject);
        const task_detail = today_task.firstChild;
        task_detail.removeChild(task_detail.querySelector(".remove"));
        task_detail.removeChild(task_detail.querySelector(".edit"));
...
function loadThisWeekTasks() {
  ...
  for (let projectObject of _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList) {
    for (let taskObject of projectObject.getTasks()) {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(taskObject.getDueDate(), new Date())) {
...
function loadProjectList() {
  ...
  for (let projectObject of _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList) {
    ...
    if (projectObject === _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList[0]){
...
function createTaskDOM(taskObject, projectObject) {
  ...
  edit.addEventListener("click", () => {
    ...
    document.querySelector("#date-input").value = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(
...
function createProjectDOM(projectObject) {
  ...
  remove.addEventListener("click", () => {
    ...
    _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.splice(_storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.indexOf(projectObject), 1);
    (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
    resetProjectAdder();
  });
...
function createProjectAdder() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (form.type === "add") {
      ...
      if (_storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.some((project) => project.getName() === newProjectName)) {
        alert("Project name must be unique");
        name_input.select();
        return;
      }

      const newProjectObject = new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"](newProjectName);

      //add new project to projectList
      _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.push(newProjectObject);
      ...
      if (
        ...
        _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.some((project) => project.getName() === newProjectName)
      ) {
        alert("Project name must be unique");
        name_input.select();
        return;
...
function getProjectList() {
  ...
  if (localStorage.projectList) {
    for (let project of JSON.parse(localStorage.projectList)) {
      const projectObject = new _project_js__WEBPACK_IMPORTED_MODULE_1__["default"](project.name);
      for (let task of project.tasks) {
        const taskObject = new _task_js__WEBPACK_IMPORTED_MODULE_0__["default"](
          task.name,
          task.description,
          task.dueDate,
          task.priority
    ...
    projectList.push(new _project_js__WEBPACK_IMPORTED_MODULE_1__["default"]("Default"));
  }

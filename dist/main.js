...
function createProjectAdder() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (form.type === "add") {
      ...
      if (_storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.some((project) => project.name === newProjectName)) {
      ...
      if (
        ...
        _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.some((project) => project.name === newProjectName)
      ) {
        alert("Project name must be unique");
        name_input.select();
        return;
...
if (_storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.length === 0) {
  const defaultProject = new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"]("Default");
  _storage_js__WEBPACK_IMPORTED_MODULE_2__.projectList.push(defaultProject);
}

(0,_DOMstuff_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_storage_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
